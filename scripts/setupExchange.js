...
async function main() {
  ...
  console.log(" Adding additional StableCoin liquidity...");
  ...
  console.log(" Added liquidity:", ethers.utils.formatEther(liquidityAmount), "LMC\n");
  ...
  console.log(" Performing swap: ETH -> LMC...");
  ...
  await swapTx.wait();
  console.log(" Swap ETH -> LMC complete!\n");
